...
#include "GasMapModelBase.h" // Virtual base class


class GasMapModel_Dynamic : public GasMapModelBase
{
public:
	GasMapModel_Dynamic(const mrpt::utils::CConfigFileBase &config_source);
